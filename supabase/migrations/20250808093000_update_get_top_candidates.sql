-- Overwrite functions to remove references to non-existent profile columns
-- Uses job_requirements for role/experience
...
CREATE OR REPLACE FUNCTION public.find_eligible_referrers_for_job(job_requirement_id UUID)
RETURNS TABLE(
  referrer_id UUID,
  referrer_name TEXT,
  referrer_role TEXT,
